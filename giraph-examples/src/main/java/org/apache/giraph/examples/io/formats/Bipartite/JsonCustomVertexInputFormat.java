package org.apache.giraph.io.formats.Bipartite;
...
public class JsonCustomVertexInputFormat extends TextVertexInputFormat <IntWritable,IntWritable,NullWritable> {
	@Override
	...
	class JsonCustomVertexReader extends TextVertexReaderFromEachLineProcessedHandlingExceptions <JSONArray,JSONException> {
		...
		@Override
		protected Vertex <IntWritable,IntWritable,NullWritable> handleException(Text line,JSONArray jsonVertex,JSONException e) {
